  ...
  return (
    <div className='relative flex h-screen w-full flex-col overflow-hidden bg-linear-to-br from-blue-50/40 to-indigo-100/50'>
      ...
      <div className='flex min-h-0 flex-1 flex-col overflow-y-auto md:flex-row'>
        <div className='relative top-0 w-full flex-auto max-lg:hidden sm:sticky lg:h-screen lg:w-[55%] lg:shrink-0 lg:self-start xl:w-[60%]'>
        ...
        <div className='flex w-full flex-auto flex-col items-center justify-between gap-5 lg:w-[45%] xl:w-[40%]'>
          <OnboardingProvider>
