...
const badgeVariants = cva(
  'focus:ring-ring inline-flex items-center gap-1 rounded-md border px-2 py-[2px] text-xs font-semibold transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none',
  {
    variants: {
      color: {
    ...
    compoundVariants: [
      ...
      },
      {
        variant: 'outline',
        color: 'dark',
        className: 'text-accent-foreground bg-accent-foreground/5'
      },
      {
        variant: 'outline',
        color: 'secondary',
        className: 'text-muted-foreground border-default-500 bg-secondary/5 dark:bg-transparent'
      },
      {
        variant: 'outline',
        color: 'default',
