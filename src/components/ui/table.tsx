...
const Table = React.forwardRef<HTMLTableElement, TableProps>(({ className, wrapperClass, ...props }, ref) => (
...
const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => <tfoot ref={ref} className={cn('bg-muted font-medium', className)} {...props} />
)
...
const TableCaption = React.forwardRef<HTMLTableCaptionElement, React.HTMLAttributes<HTMLTableCaptionElement>>(
  ({ className, ...props }, ref) => (
    <caption ref={ref} className={cn('text-default-700 mb-4 text-start text-sm font-medium', className)} {...props} />
  )
)
