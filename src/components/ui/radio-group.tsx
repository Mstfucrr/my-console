...
const radioVariants = cva(
  'border-default-400 data-[state=checked]:text-default-700 ring-offset-background focus-visible:ring-ring disabled:bg-default-100 disabled:border-default-400 aspect-square h-5 w-5 rounded-full border focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:fill-current [&_svg]:text-current',
  {
    variants: {
      color: {
        ...
        destructive: 'data-[state=checked]:border-destructive data-[state=checked]:text-destructive',
        secondary: 'data-[state=checked]:border-default-300 data-[state=checked]:text-default-300'
      },
      variant: {
        faded: ''
      },
