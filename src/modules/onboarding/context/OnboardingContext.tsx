...
export function OnboardingProvider({ children }: { children: ReactNode }) {
  const form = useForm<OnboardingFormData>({
    ...
    defaultValues: {
      // Company Info
      companyName: 'ABC Restoran Ltd. Şti.',
      companyType: 'kooperatif',
      taxNumber: '1234567890',
      taxOffice: 'İstanbul',
      companyPhone: '5321234567',
      companyEmail: 'abc@restoran.com',

      // Address Info
      companyAddress: 'İstanbul Bağcılar',
      companyCity: 'İstanbul',
      companyDistrict: 'Kadıköy',
      billingAddress: 'İstanbul Bağcılar',
      ...
      managerPhone: '5321234567',
      managerEmail: 'ahmet@restoran.com',
      accountantName: 'Mehmet Yılmaz',
      accountantPhone: '5321234567',
      accountantEmail: 'mehmet@restoran.com',
