...
export function B2BCartAside() {
  return (
    <aside className='border-border/70 bg-card sticky top-20 hidden h-auto max-h-[calc(100vh-10rem)] w-80 shrink-0 flex-col overflow-hidden rounded-xl border shadow-sm lg:flex 2xl:w-84'>
